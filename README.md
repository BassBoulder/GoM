...
v0.2.2.0--Jan24 Changlog: "MIGRATION TO DATA ASSETS (FROM DATA TABLE)"
* SORTED - #
...
* SORTED - #473 (BUG) - Can't craft if no space available
...
* SORTED - #22 Create Equipment System v2 (Head, Chest, Accessory #1 & #2, Side & Main Weapon slots)
* SORTED - #669 Updated Redirectors
* SORTED - #670 Updated SaveLoad Logic For Additional Equipment Slots
...
* SORTED - #644 Upgrade Stairs to v2 (3D) 
* SORTED - #645 Create Small Stairs Template in Blender (3D)
* SORTED - #649 Upgrade Shutter Switch to v3 (3D)
* SORTED - #653 Create Large Stairs Template in Blender (3D)
...
* SORTED - #317 Create Sarah Bathroom Level
* SORTED - #388 Bathroom Shutter Interaction
* SORTED - #469 Added Shutter functionality to Protagonist Bathroom
* SORTED - #470 Added Shutter functionality to Jackie Bathroom
* SORTED - #471 Added Shutter functionality to Sarah Bathroom
* SORTED - #543 Tidy-Up Folder & Files for Bathroom Assets
...
* SORTED - #496 Bug - Desk Light not turning-on
* SORTED - #531 Bug - Movement Issue on Play
...
* SORTED - #402 Create Upper Dorms Right Level Assets
* SORTED - #397 Create Upper Dorm Shutter Functionality
------------------------------------------------------------------------------------
...
* SORTED - #364 Created Instance Editable Name for Storage Text
